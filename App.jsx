    ...
    <>
      ...
      <div className=' h-[100vh] w-[100vw]flex justify-center'>
          ...
          <div className='inline-flex m-[4vw]'>
            <img className='w-[30vw] h-[35vh]' src="https://tint.creativemarket.com/-fc2O8L6UQr741mlhB4cXKO-iCoIFi9Zha4rZ_Lqyc4/width:1820/height:1214/gravity:nowe/rt:fill-down/el:1/czM6Ly9maWxlcy5jcmVhdGl2ZW1hcmtldC5jb20vaW1hZ2VzL3NjcmVlbnNob3RzL3Byb2R1Y3RzLzg3Mi84NzIxLzg3MjE0NTQvc3BhY2UtdHJhdmVsLW8ucG5n?1594759552" alt="" />
            <p className=' font-sans text-[1.5vw] h-[35vh] w-[70vw] p-[1vw] border-l-[1vw] bg-orange-50'>
